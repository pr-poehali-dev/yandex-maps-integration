        ...
        <div className="mb-10">
          ...
          <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-4">
            {[
              ...
              { name: 'Кирилл Захаров', level: 4, date: '3 февраля 2025', rating: 5, text: 'Заказал онлайн с доставкой по Долгопрудному — привезли буквально за час! Упаковано аккуратно, всё целое. Взял корейскую косметику жене и азиатские снеки — всё понравилось. Буду заказывать ещё 🙌' },
              { name: 'Ольга Смирнова', level: 2, date: '14 марта 2025', rating: 5, text: 'Доставка по городу просто огонь — оформила заказ в обед, уже вечером всё было дома. Курьер вежливый, позвонил заранее. Bubble Tea Matcha — просто восторг, теперь беру регулярно!' },
              { name: 'Денис Коваль', level: 6, date: '20 января 2025', rating: 5, text: 'Давно искал нормальный магазин азиатских товаров в Долгопрудном — нашёл! Ассортимент огромный, цены адекватные. Заказал онлайн, доставили быстро и бесплатно. Снеки Chimi Mix — лучшие!' },
              { name: 'Светлана Морозова', level: 3, date: '5 апреля 2025', rating: 5, text: 'Брала маски для лица Jeju и сыворотку — качество отличное, как в корейских магазинах. Доставка по Долгопрудному пришла очень быстро. Девочки, советую всем кто следит за кожей ✨' },
              { name: 'Тимур Исаев', level: 5, date: '11 мая 2025', rating: 5, text: 'Заказал игрушку Куро сыну на день рождения через сайт. Оформление простое, оплата удобная, доставили в нужный день. Сын счастлив! Мягкая, большая, качественная. Спасибо Се-Се! 🎁' },
              { name: 'Алина Попова', level: 2, date: '28 июня 2025', rating: 5, text: 'Случайно нашла этот магазин в интернете, решила попробовать заказать. Привезли быстро, всё как на фото. Набор ручек Kawaii — просто прелесть, дочка в восторге. Теперь только здесь закупаемся!' },
              { name: 'Максим Белов', level: 4, date: '7 июля 2025', rating: 5, text: 'Брал Рамен Tonkotsu и газировку Yuzu — необычно и вкусно. Удобно что можно заказать онлайн и получить доставку прямо домой в Долгопрудном. Больше никаких поездок в Москву за азиатскими вкусняшками 😄' },
              { name: 'Юлия Фёдорова', level: 3, date: '19 августа 2025', rating: 5, text: 'Пришли в магазин всей семьёй — дети уходить не хотели! Столько всего интересного. Взяли игрушки, снеки и косметику. Персонал приветливый, всё объяснил. Однозначно вернёмся!' },
              { name: 'Роман Козлов', level: 5, date: '2 сентября 2025', rating: 5, text: 'Оформил заказ на сайте поздно вечером, утром уже позвонили и уточнили детали. К обеду всё было у меня. Вот это сервис! Питбайк взял для дачи — доставили аккуратно, без царапин. Рекомендую!' },
              { name: 'Валерия Новикова', level: 2, date: '15 октября 2025', rating: 5, text: 'Впервые попробовала азиатскую косметику — маска Bamboo просто чудо, кожа после неё бархатная! Заказала ещё несколько позиций с доставкой. Привезли быстро и в хорошей упаковке. Подруги уже завидуют 😊' },
              { name: 'Игорь Соколов', level: 6, date: '30 октября 2025', rating: 5, text: 'Купил квадроцикл для сына — менеджер помог с выбором, всё объяснил, ответил на все вопросы. Доставка по городу была бесплатной. Ребёнок счастлив, мы тоже! Магазин заслуживает доверия 💪' },
            ].map(r => (
