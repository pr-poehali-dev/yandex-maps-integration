    ...
    <div className="min-h-screen">
      ...
      <section className="container py-20">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground mt-3 text-lg">Реальные отзывы наших покупателей из Долгопрудного</p>
        </div>

        {/* Отзывы покупателей сайта */}
        <div className="mb-10">
          <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-4">
            {[
              { name: 'Андрей В.', city: 'Долгопрудный', date: '1 апр 2025', rating: 5, text: 'Отличный магазин, очень уютно, чисто! Отличный товар и доброжелательный персонал! Очень много интересного и нового для себя нашел 👍' },
              { name: 'Марго Т.', city: 'Долгопрудный', date: '30 авг 2025', rating: 5, text: 'Недавно побывали с детьми — теперь мы там частые гости. Как заходишь, сразу приятный аромат встречает и хорошая музыка. Много разных необычных товаров!' },
              { name: 'Надежда П.', city: 'Долгопрудный', date: '21 сен 2024', rating: 5, text: 'Гуляя с дочкой решила зайти. Такой приятный глазу ремонт, вкусно пахнет, в общем уйти без улова не смогла 😍 Фотографировала подруге с рекомендациями!' },
              { name: 'Виктор Р.', city: 'Долгопрудный', date: '9 май 2025', rating: 5, text: 'Первый раз зашёл просто посмотреть — взял несколько азиатских сладостей и мороженное. Очень понравилась атмосфера, всё чисто и красиво оформлено!' },
              { name: 'Анастасия Б.', city: 'Долгопрудный', date: '16 сен 2024', rating: 5, text: 'Очень давно ждали открытия! Пришли сразу — были приятно удивлены не только ассортиментом, но и ценой. Взяли на пробу и ни о чём не пожалели, вернёмся ещё!' },
              { name: 'Сергей М.', city: 'Долгопрудный', date: '29 ноя 2025', rating: 5, text: 'Много интересных товаров, но больше всего захватили газированные напитки. Есть всё — Mountain Dew, Coca-Cola, Sprite. Захожу регулярно, рекомендую! 🔥' },
              { name: 'Кирилл З.', city: 'Долгопрудный', date: '3 фев 2025', rating: 5, text: 'Заказал онлайн с доставкой — привезли буквально за час! Упаковано аккуратно, всё целое. Взял корейскую косметику жене и азиатские снеки — всё понравилось 🙌' },
              { name: 'Ольга С.', city: 'Долгопрудный', date: '14 мар 2025', rating: 5, text: 'Доставка по городу просто огонь — оформила заказ в обед, уже вечером всё было дома. Курьер вежливый, позвонил заранее. Bubble Tea Matcha — восторг, теперь беру регулярно!' },
              { name: 'Денис К.', city: 'Долгопрудный', date: '20 янв 2025', rating: 5, text: 'Давно искал нормальный магазин азиатских товаров — нашёл! Ассортимент огромный, цены адекватные. Заказал онлайн, доставили быстро и бесплатно. Снеки Chimi Mix — лучшие!' },
              { name: 'Светлана М.', city: 'Долгопрудный', date: '5 апр 2025', rating: 5, text: 'Брала маски для лица и сыворотку — качество отличное, как в корейских магазинах. Доставка пришла очень быстро. Девочки, советую всем кто следит за кожей ✨' },
              { name: 'Тимур И.', city: 'Долгопрудный', date: '11 май 2025', rating: 5, text: 'Заказал игрушку Куро сыну на день рождения через сайт. Оформление простое, оплата удобная, доставили в нужный день. Сын счастлив! Качество отличное. Спасибо! 🎁' },
              { name: 'Алина П.', city: 'Долгопрудный', date: '28 июн 2025', rating: 5, text: 'Случайно нашла в интернете, решила попробовать заказать. Привезли быстро, всё как на фото. Набор ручек Kawaii — просто прелесть, дочка в восторге. Теперь только здесь!' },
              { name: 'Максим Б.', city: 'Долгопрудный', date: '7 июл 2025', rating: 5, text: 'Брал Рамен Tonkotsu и газировку Yuzu — необычно и вкусно. Удобно заказывать онлайн и получать доставку домой. Больше никаких поездок в Москву за вкусняшками 😄' },
              { name: 'Юлия Ф.', city: 'Долгопрудный', date: '19 авг 2025', rating: 5, text: 'Пришли в магазин всей семьёй — дети уходить не хотели! Взяли игрушки, снеки и косметику. Персонал приветливый, всё объяснил и помог с выбором. Вернёмся!' },
              { name: 'Роман К.', city: 'Долгопрудный', date: '2 сен 2025', rating: 5, text: 'Оформил заказ поздно вечером, утром позвонили и уточнили детали. К обеду всё было у меня. Вот это сервис! Питбайк взял для дачи — доставили аккуратно, рекомендую!' },
              ...
              <div key={r.name + r.date} className="bg-card border border-border rounded-2xl p-5 flex flex-col gap-3 hover-scale">
                ...
                <div className="pt-3 border-t border-border flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">{r.city} · Покупатель сайта</p>
                  </div>
                  <div className="ml-auto flex items-center gap-1 text-xs text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded-full font-medium">
                    <Icon name="BadgeCheck" size={11}/> Проверено
                  </div>
                </div>
              </div>
            ))}
